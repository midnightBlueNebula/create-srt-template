def createSRTTemplate(vid_h,vid_m,vid_s):
  ...
  s = 0
  len = 0
  vid_len = vid_h*60 + vid_m + vid_s/60.0
  it = 1
  while len < vid_len:
    if (h < 10):
      p_h = "0"+str(h)
    ...
    if (s < 57):
      ...
      if (m+1<10):
        print(p_h+":"+p_m+":"+p_s+",500"+" --> " + p_h+":0"+str(int(p_m)+1)+":0"+str(int(p_s)+3-60)+",000")
      else:
      ...
      if (h+1 < 10):
        print(p_h+":"+p_m+":"+p_s+",500"+" --> 0" + str(int(p_h)+1)+":"+"00"+":0"+str(int(p_s)+3-60)+",000")
      else:
        print(p_h+":"+p_m+":"+p_s+",500"+" --> " + str(int(p_h)+1)+":"+"00"+":0"+str(int(p_s)+3-60)+",000")
      h += 1
      m = 0
      s += 3 - 60
